...
import com.projetojpa.services.CursoService; 

import io.swagger.v3.oas.annotations.Operation; 
import io.swagger.v3.oas.annotations.tags.Tag; 
import jakarta.validation.Valid; 

@Tag(name = "Cursos", description = "API REST DE GERENCIAMETO DE CLIENTES")  
@RestController   
...
public class CursoController {   
	...
	public ResponseEntity<Curso> alteraCursosControl(@PathVariable Long id, @RequestBody @Valid Curso curso){   
